Blockly.Blocks['scrollbit_import'] = {
  init: function () {
...
Blockly.Blocks['scrollbit_scroll'] = {
  init: function() {
    this.appendDummyInput()
        .appendField("scroll(")
...
Blockly.Blocks['scrollbit_write'] = {
  init: function() {
    this.appendDummyInput()
        .appendField("write(")
    this.appendValueInput("text")
...
Blockly.Blocks['scrollbit_pixel'] = {
  init: function() {
    this.appendDummyInput()
...
Blockly.Blocks['scrollbit_clear'] = {
  init: function() {
    this.appendDummyInput()
        .appendField("clear()")
    this.setPreviousStatement(true, null);
